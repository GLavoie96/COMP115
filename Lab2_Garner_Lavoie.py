...
#---------------------------------------------------------
print("Exercise 8") # Just to create some seperation between Q. 7 & 8 

def first_even_natural_nums():
    total = int(input("Enter the total number of even natural number: "))
    x = 2
    count = 0
    while count < total:
        print(x)
