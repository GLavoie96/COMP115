...
assert average([11, 1, 7, 4, 40, 15]) == 13
assert average([9, 221, 15, 13, 7]) == 53
assert average([100, 55, 77, 98, 120]) == 90
...
assert find_max([12, 47, 21, 67, 89, 5]) == 89
assert find_max([5, 2, 8, 15, 3]) == 15
assert find_max([100, 55, 78, 99, 120]) == 120
# Write and pass your units tests (5 marks)
...
assert squares([0, 5, 10]) == [0, 25, 100]
# Write and pass your units tests (5 marks)
