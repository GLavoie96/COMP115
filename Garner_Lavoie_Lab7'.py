...
assert remove_duplicates_set('banner') == 'baner'
...
"""
def students_id(ids):
    personal_ids = set(ids)
    return len(personal_ids)

# Your unit tests
assert students_id(['001','002','003','004','005']) == 5
assert students_id(['012','011','001']) == 3
...
assert students_id_occurrences(['002','002','001','011','001']) == {'001': 2,'002': 2,'011':1}
"""
